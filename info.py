...
support_chat_id = environ.get('SUPPORT_CHAT_ID','-1001948984400')
reqst_channel = environ.get('REQST_CHANNEL_ID','-1001948984400')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001948984400')).split()]
