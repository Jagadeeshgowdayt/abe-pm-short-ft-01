...
GRP_LNK = environ.get('GRP_LNK', 'https://telegram.me/abj_roBOT')
CHNL_LNK = environ.get('CHNL_LNK', 'https://telegram.me/abj_roBOT')
UPDATE_CHANNEL = environ.get('CHNL_LNK', 'https://telegram.me/abj_roBOT')
MSG_ALRT = environ.get('MSG_ALRT', '❤ ᴊᴏɪɴ @abj_roBOT ❤')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001800045212))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'abj_roBOT')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
TUTORIAL = environ.get('TUTORIAL', 'https://telegram.me/abj_roBOT')
BUY_PREMIUM = environ.get('TUTORIAL', 'https://telegram.me/abj_roBOT')
