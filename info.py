...
PICS = (environ.get('PICS', 'https://telegra.ph/file/bbe8f0853e55012baea8b.jpg https://telegra.ph/file/bbe8f0853e55012baea8b.jpg')).split()
...
support_chat_id = environ.get('SUPPORT_CHAT_ID','-1001685283094')
reqst_channel = environ.get('REQST_CHANNEL_ID','-1001685283094')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://telegram:telegram@telegram.khfz75n.mongodb.net/?retryWrites=true&w=majority")
...
GRP_LNK = environ.get('GRP_LNK', 'https://telegram.me/abj_bot_update')
CHNL_LNK = environ.get('CHNL_LNK', 'https://telegram.me/abj_bot_update')
UPDATE_CHANNEL = environ.get('CHNL_LNK', 'https://telegram.me/abj_bot_update')
MSG_ALRT = environ.get('MSG_ALRT', '❤ ᴊᴏɪɴ @abj_bot_update ❤')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001800045212))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'abj_bot_update')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
TUTORIAL = environ.get('TUTORIAL', 'https://telegram.me/abj_bot_update')
BUY_PREMIUM = environ.get('TUTORIAL', 'https://telegram.me/abj_bot_update')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001685283094')).split()]
